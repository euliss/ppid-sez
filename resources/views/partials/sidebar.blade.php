<aside
    ...
    class="sidebar fixed left-0 top-0 z-9999 flex h-screen w-[260px] flex-col overflow-y-hidden border-r border-gray-200 bg-white px-5 dark:border-gray-800 dark:bg-black lg:static lg:translate-x-0"
>
    <!-- SIDEBAR HEADER -->
    <div
    ...
    >
      ...
      <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
        <img class="w-[150px] h-auto dark:hidden" src="{{ asset('tailadmin/build/src/images/logo/logosez2.svg') }}" alt="Logo"/>
        <img
            class="hidden dark:block w-[150px]"
        ...
        />
            ...
            <img
                ...
                src="{{ asset('tailadmin/build/src/images/logo/logosez2.svg') }}"
                alt="Logo"
            />
        </a>
    </div>
          ...
          >
            MENU
                ...
                Informasi
                        ...
                        <!-- Dropdown Sub Menu Informasi Publik  -->
                        <div
                            class="overflow-hidden transform translate"
